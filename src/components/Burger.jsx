...
function Burger({burger1image, burgername, burgersubtext}) {
  ...
  return (
    <div className="card1 h-[90%] w-[20%] rounded-md border-[2px] border-gray-400">
      <div
      ...
      <div className="rating h-[10%] w-full flex justify-between items-center">
        ...
        <div className="heart font-bold text-gray-400 px-4">
            {heart ? <FaHeart className="text-[20px] text-pink-400 cursor-pointer" onClick={() => setheartyes(!heart)} /> : <CiHeart className="text-[20px] cursor-pointer" onClick={() => setheartyes(!heart)} />}
      ...
      <div className="sellcart px-2  h-[12%] w-full  flex justify-between items-center">
        <div className="price h-[75%] rounded-md w-[65px] bg-yellow-800 flex justify-center items-center font-mono font-bold text-yellow-600">Free</div>
